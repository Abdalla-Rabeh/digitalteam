            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (count($categories) > 0)
                        ...
                        @else
                            <form onsubmit="return btnCheckListGet()" action="{{ route('blog-category.destroy_checked') }}" method="POST">
                                @method('DELETE')
                                @csrf
                                @endif
                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                            @php $desc = count($categories); $asc=0; @endphp
                            @foreach ($categories as $category)
                                <tr>
                                    <td>
                                        <input  name="check_list[]" type="checkbox" value="{{ $category->id }}" onclick="showHideDeleteButton2(this)"> <span class="d-none">{{ $asc++ }}{{ $desc-- }}</span>
                                    </td>
