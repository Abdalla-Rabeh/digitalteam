                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="breadcrumb_status" class="form-control" id="breadcrumb_status">
                                                                    ...
                                                                    <option value="1" {{ $blog->breadcrumb_status == 1 ? 'selected' : '' }}>{{ __('content.yes') }}</option>
                                                                    <option value="0" {{ $blog->breadcrumb_status == 0 ? 'selected' : '' }}>{{ __('content.no') }}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="media">
                                                                                @if (!empty($blog->custom_breadcrumb_image))
                                                                                    <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                                                        <img src="{{ asset('uploads/img/blogs/breadcrumb/'.$blog->custom_breadcrumb_image) }}" alt="service image" class="rounded">
                                                                                    </a>
                                                                                @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="short_desc" name="short_desc" class="form-control">{{ $blog->short_desc }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="image_status">
                                            ...
                                            <option value="1" {{ $blog->image_status == 1 ? 'selected' : '' }}>{{ __('content.enable') }}</option>
                                            <option value="0" {{ $blog->image_status == 0 ? 'selected' : '' }}>{{ __('content.disable') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option value="1" selected>{{ __('content.select_your_option') }}</option>
                                            <option value="1" {{ $blog->status == 1 ? 'selected' : '' }}>{{ __('content.published') }}</option>
                                            <option value="0" {{ $blog->status == 0 ? 'selected' : '' }}>{{ __('content.draft') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
