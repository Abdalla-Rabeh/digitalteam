...
Route::get('/', [HomeController::class, 'index'])->name('homepage')->middleware('XSS');
 Route::get('/about', [HomeController::class, 'about'])->name('about')->middleware('XSS');
 Route::get('/contact', [HomeController::class, 'contact'])->name('contact')->middleware('XSS');
 Route::get('/service', [HomeController::class, 'service'])->name('service')->middleware('XSS');
// Route::get('/portfolios', [HomeController::class, 'portfolios'])->name('portfolios')->middleware('XSS');
