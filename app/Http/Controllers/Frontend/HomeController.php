...
class HomeController extends Controller
{
     ...
     */
     ...
     public function portfolios(){
        ...
        return view('frontend.portfolio.', compact('about'));
     ...
     public function about()
     {
        ...
        $about = About::where('language_id', $language->id)->first();
        return view('frontend.about.about', compact('about','socials','site_info','footer_pages','info_lists'));
     }
     ...
     public function contact()
     {
        ...
        return view('frontend.contact.index',compact('contacts','contact_section','socials','site_info','footer_pages'));
     ...
     public function service()
     {
        ...
        return view('frontend.service.service',compact('services','footer_pages','service_limit','socials','site_info','service_paginate','service_section'));
     }
